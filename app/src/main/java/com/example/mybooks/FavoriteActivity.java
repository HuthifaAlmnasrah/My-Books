...
public class FavoriteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new BookRecyclerViewAdapter(FavoriteActivity.this,"favorite");
        booksRecycler.setAdapter(adapter);
        booksRecycler.setLayoutManager(new LinearLayoutManager(FavoriteActivity.this));
        adapter.setBooks(Utils.getFavoriteBooks());

        ConstraintLayout layout = findViewById(R.id.parent);
        if(Utils.getFavoriteBooks().size()==0){
    ...
    public void onBackPressed() {
        startActivity(new Intent(FavoriteActivity.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK));
    }
}